...
function GetTemplateDataHelper(template, player, auraTemplates, resources, modifiers = {})
{
	...
	if (template.Cost)
	{
		...
		//HC-Code
		if (template.Cost.BattalionSlots)
			ret.cost.BattalionSlots = getEntityValue("Cost/BattalionSlots");
...
function GetTechnologyDataHelper(template, civ, resources)
{
	...
	ret.heroSelectionDescriptionElements = template.heroSelectionDescriptionElements; // HC-Code: Needed to read the hero description which is displayed in the civ-choices dialog
