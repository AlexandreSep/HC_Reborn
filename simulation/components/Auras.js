...
Auras.prototype.Init = function()
{
	...
	// HC-Code
	// Constants for transformation code
	this.entitiesToTransformGlobally = new Array();
	this.transformationTimerID = 0;
...
Auras.prototype.ApplyAura = function(name, ents)
{
	...
	// HC-Code
	// HC-TODO: This needs to be checked and maybe moved elsewhere
	// Everything transformation related happens here
	this.DoTransformationIfSpecified(name, ents);
