...
Attack.prototype.knockbackBonusSchema =
    "<optional>" +
        "<element name='Knockback' a:help='Knock the target back the given number of cells'>" +
            "<interleave>" +
                "<element name='Horizontal' a:help='The Horizontal Strength of the Knockback.'><data type='positiveInteger'/></element>" +
                "<optional>" +
                    "<element name='Vertical' a:help='The Vertical Strength of the Knockback.'><data type='positiveInteger'/></element>" +
                "</optional>" +
            "</interleave>" +
        "</element>" +
    "</optional>";

Attack.prototype.stunBonusSchema =
    "<optional>" +
        "<element name='Stun' a:help='Stun the target for set miliseconds'>" +
            "<interleave>" +
                "<element name='Time' a:help='the base time in miliseconds'><data type='positiveInteger'/></element>" +
                "<element name='Chance' a:help='Chance the stun will occur'><ref name='nonNegativeDecimal'/></element>" +
            "</interleave>" +
        "</element>" +
    "</optional>";
...
Attack.prototype.Schema =
	...
	"<oneOrMore>" +
		...
		// HC-End
				...
				"<optional>" +
					"<element name='Splash'>" +
						"<interleave>" +
							...
							AttackHelper.BuildAttackEffectsSchema() +
							Attack.prototype.knockbackBonusSchema +	//HC-Code
                ...
                Attack.prototype.knockbackBonusSchema +	// HC-Code
				Attack.prototype.stunBonusSchema +		// HC-Code
				Attack.prototype.trueDamageSchema +		// HC-Code
				Attack.prototype.preferredClassesSchema +
				Attack.prototype.restrictedClassesSchema +
			"</interleave>" +
		"</element>" +
