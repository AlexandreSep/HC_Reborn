...
/**
 * Message of the form { "player": player, "id": battalionID, "entities": entities }
 * sent from Player when a battalion has been added
 */
Engine.RegisterMessageType("BattalionAdded");

/**
 * Message of the form { "data": battalion entities aka data, "id": battalion ID, "delete": exists if a battalion was deleted, "entity": replaced entity if applicable }
 * sent from Player and Health when a battalions status has been updated whether by removal, deletion or replacement
 */
Engine.RegisterMessageType("BattalionUpdate");
