...
Cost.prototype.Schema =
	...
	// HC-Code
    "<optional>"  +
        "<element name='BattalionSlots' a:help='When using battalions, set Population to 0 and use this instead'><text/></element>" +
    "</optional>"  +
    // HC-End
...
Cost.prototype.Init = function()
{
    ...
    if (this.template.BattalionSlots) {
        this.battalionSlots = +this.template.BattalionSlots;
    }
};
