...
ResourceGatherer.prototype.Schema =
	...
	// HC-Code
	"<optional>" +
		"<element name='ConvertAllResourcesOnDeposit' a:help='Converts all resources when committed to the specified one'>" +
			"<text/>" +
		"</element>" +
	"</optional>" +
	"<optional>" +
		"<element name='ConvertOnDeposit' a:help='Converts individual resources when committed'>" +
			"<optional>" +
				"<element name='food'>" +
					"<element name='ConvertTo'><text/></element>" +
                    "<element name='Ratio'><ref name='positiveDecimal'/></element>" +
				"</element>" +
			"</optional>" +
			"<optional>" +
				"<element name='wood'>" +
...
ResourceGatherer.prototype.CommitResources = function(target)
{
	...
	this.ConvertResourcesHyrule(); // HC-Code
